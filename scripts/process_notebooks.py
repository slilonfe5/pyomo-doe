...
def process_notebook(
    ...
    replace_markdown(
        '<b>Home Activity</b>:', '<p class=\"title\"><b>Home Activity</b></p>\n'
    )
    replace_markdown(
    ...
    replace_markdown(
        '<b>Tutorial Activity</b>:', '<p class=\"title\"><b>Tutorial Activity</b></p>\n'
    )
    ...
    replace_markdown(
        '<b>Class Activity</b>:', '<p class=\"title\"><b>Class Activity</b></p>\n'
    )
    ...
    for cell in nb.cells:
        if cell.cell_type == "markdown":
            ...
            for txt, media_file in media_links:
                ...
                print(
                    f"    found link to media file: ![{txt}](../../media/{media_file})"
                )
